...
<html lang="en">
  <head>
    ...
    <link href="<?php echo base_url(); ?>assets/admin/jqvmap/jqvmap.css" media="screen" rel="stylesheet" type="text/css" />
    ...
    <div class="templatemo-flex-row">
      <div class="templatemo-sidebar">
        ...
        <nav class="templatemo-left-nav">
          <ul>
            <li><a href="centro2.html"><i class="fa fa-home fa-fw"></i>Dashboard</a></li>
