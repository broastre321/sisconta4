    ...
    <div class="templatemo-flex-row">
      <div class="templatemo-sidebar">
        ...
        <nav class="templatemo-left-nav">
          <ul>
            <li><a href="<?php echo base_url(); ?>admin"><i class="fa fa-home fa-fw"></i>Dashboard</a></li>
            <li><a href="<?php echo base_url(); ?>data-visualization"><i class="fa fa-bar-chart fa-fw"></i>Charts</a></li>
            <li><a href="<?php echo base_url(); ?>data-visualization"><i class="fa fa-database fa-fw"></i>Data Visualization</a></li>
            <li><a href="<?php echo base_url(); ?>maps"><i class="fa fa-map-marker fa-fw"></i>Maps</a></li>
            <li><a href="<?php echo base_url(); ?>manage-users"><i class="fa fa-users fa-fw"></i>Manage Users</a></li>
      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-content-widget white-bg">
            ...
            <form action="centro2.html" class="templatemo-login-form" method="post" enctype="multipart/form-data">
