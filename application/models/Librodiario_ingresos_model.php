...
class Librodiario_ingresos_model extends CI_Model
{
    ...
    public function get_ingresos_filtro($inicio, $fin)
    {
      # code...
    ...
    public function get_ingresos(){
        ...
        $this->db->join('cuentas','cuentas.codigo = ficha.cuentas_codigo');
         ...
         $this->db->where('tipo_cuentas.idtipo_cuentas',1);
